...
class BlurDetection:
    ...
    def Test_Tenengrad(self):
        ...
        for i in range(len(imgList)):
            Tenengrad_score = self._Tenengrad(imgList[i])
            print(str(imgList[i]) + " is1 " + str(Tenengrad_score))
            #print(score)
            arr.append(int(Tenengrad_score))

    def Test_Vollath(self):
        imgList = self._getAllImg(self.strDir)
        for i in range(len(imgList)):
            score = self._Variance(imgList[i])
            print(str(imgList[i]) + " is2 " + str(score))
    ...
    def TestVariance(self):
        ...
        for i in range(len(imgList)):
            score = self._Variance(imgList[i])
            print(str(imgList[i]) + " is3 " + str(score))
    ...
    def TestSMD2(self):
        ...
        for i in range(len(imgList)):
            ...
            print(str(imgList[i]) + " is4 " + str(score))
        return
    def TestSMD(self):
        imgList = self._getAllImg(self.strDir)

        for i in range(len(imgList)):
            SMD_score = self._SMDDetection(imgList[i])
            print(str(imgList[i]) + " is5(SMD) " + str(SMD_score))

            # print(score)
            arr2.append(int(SMD_score))
    ...
    def TestBrener(self):
        ...
        for i in range(len(imgList)):
            ...
            print(str(imgList[i]) + " is6 " + str(score))
    ...
    def TestDect(self):
        ...
        for i in range(len(names)):
            Lap_score = self._lapulaseDetection(names[i])
            print(str(names[i]) + " is7 " + str(Lap_score))
            #print(score)
            arr3.append(int(Lap_score))
        return
...
if __name__ == "__main__":
    BlurDetection = BlurDetection(strDir="F:/Lan2/SFL-D2AAE/BM/train14/test_all/")
    ...
    mean=np.mean(Tenengrad_score)
    print('Tenengrad_score_mean',mean)
    std=np.std(Tenengrad_score)
    print('Tenengrad_score_std',std)

    Lap_mean=np.mean(Lap_score)
    print('Lap_score_mean',Lap_mean)
    Lap_std=np.std(Lap_score)
    print('Lap_score_std',Lap_std)
