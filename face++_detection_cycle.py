...
faceId1= []
dataset1_name='F:/Lan/face_aging_with_CycleGan-master/AF/train1/11-20to31-40/test/'
f_names1 = glob(os.path.join('F:/Lan/face_aging_with_CycleGan-master/AF/train1/11-20to31-40/test/', dataset1_name, '*.jpg'))
# label0=[]
# label1=[]
# label2=[]
# label3=[]
