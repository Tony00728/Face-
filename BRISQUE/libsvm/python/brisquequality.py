...
#qualityscore = test_measure_BRISQUE('F:/Lan/FS-D2AAE/BM/train14/test_all/65_0_1_20170117162906228_colflip.jpg.chip_0.png')

arr=[]
dataset1_name='F:/Lan/FS-D2AAE/WM/train4/test_all_min/'
f_names1 = glob(os.path.join('F:/Lan/FS-D2AAE/WM/train4/test_all_min/', dataset1_name, '*.png'))
for i in tqdm(range(0,len(f_names1))):
    #print(f_names1[i])
    qualityscore = test_measure_BRISQUE(f_names1[i])
    arr.append(qualityscore)
#qualityscore = test_measure_BRISQUE(sys.argv[1])
#print("Score of the given image: ", qualityscore)
qualityscore=arr
print(qualityscore)
mean=np.mean(qualityscore)
print('qualityscore_mean',mean)
std=np.std(qualityscore)
print('qualityscore_std',std)