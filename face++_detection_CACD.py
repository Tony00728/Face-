...
faceId1= []
dataset1_name='F:/Lan/FS-D2AAE/CACD/All/train1/test_CACD_WM150_All/'
f_names1 = glob(os.path.join('F:/Lan/FS-D2AAE/CACD/All/train1/test_CACD_WM150_All/', dataset1_name, '*.png'))
label0=[]
label1=[]
label2=[]
label3=[]
