...
faceId1= []
dataset1_name='F:/Lan/WCC_Cycle_GAN/CycleGAN-TensorFlow-master/AF/label0_label5/'
f_names1 = glob(os.path.join('F:/Lan/WCC_Cycle_GAN/CycleGAN-TensorFlow-master/AF/label0_label5/', dataset1_name, '*.jpg'))
# label0=[]
# label1=[]
# label2=[]
# label3=[]
