...
faceId1= []
dataset1_name='F:/Lan/classification/test_dataset_class2/11-20/AF/'
f_names1 = glob(os.path.join('F:/Lan/classification/test_dataset_class2/11-20/AF/', dataset1_name, '*.jpg'))
#print(f_names1)


faceId2=[]
dataset2_name='F:/Lan/face_aging_with_CycleGan-master/AF/train1/11-20to61-70/test/'
f_names2 = glob(os.path.join('F:/Lan/face_aging_with_CycleGan-master/AF/train1/11-20to61-70/test/', dataset2_name, '*.jpg'))
#print(f_names2)
