...
key ="di4WD8lWXw7wmg5wZ2HQKARdFXGK56uY"
secret ="2cUyuO9TsP__zbETstm596Rh67aaPDTG"

#原圖
faceId1= []
dataset1_name='/home/tony/FFHQ_testing_white_males/70+/image'
f_names1 = glob(os.path.join('/home/tony/FFHQ_testing_white_males/70+/image', dataset1_name, '*.jpg'))
#print(f_names1)
...
#test
faceId2=[]
dataset2_name='/home/tony/exp/exp_fading_shapeloss_white_males/70+/inference_results/75'
f_names2 = glob(os.path.join('/home/tony/exp/exp_fading_shapeloss_white_males/70+/inference_results/75', dataset2_name, '*.PNG'))  #PNG jpg
writepath = "/home/tony/exp/exp_fading_shapeloss_white_males/70+/inference_results/75_identity.xlsx"  # .csv
#print(f_names2)
